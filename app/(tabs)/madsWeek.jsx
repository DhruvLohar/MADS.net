...
const MADSWeekView = () => {
  ...
  const rules = [
    "Supposed to be a web app.",
    "Any web framework can be used.",
    "No need of adding backend functionality.",
    "only a working frontend is expected.",
  ];
        ...
        <View style={[LAYOUTS.screenView, { marginTop: 30 }]}>
          <ScrollView>
            ...
            <Text style={TYPOGRAPHY.Body}>
              MADS Week is now live! Participate at par with your classmates and
              win MADS Points and realife project experience!
            </Text>
            <Carousel images={images} />
            <Text style={TYPOGRAPHY.SubTitle}>Instagram Clone Web App</Text>
            <Text style={TYPOGRAPHY.Body}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean
              euismod arcu sed odio consectetur condimentum. Maecenas non
              ultrices massa. Nullam eget viverra est. Aliquam odio erat,
              laoreet ut ex tristique, interdum pretium eros.
            </Text>
            <Text style={TYPOGRAPHY.Body}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean
              euismod arcu sed odio consectetur condimentum. Maecenas non
